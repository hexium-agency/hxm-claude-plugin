...
trigger: Use when working with an external library, framework or package and up-to-date documentation is needed — API usage, version-specific behaviour, configuration or migration.
requires: context7
---
