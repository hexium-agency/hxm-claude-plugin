...
trigger: Use when the task involves defensive security — vulnerability assessment, OWASP Top 10 compliance, dependency scanning, secret detection or security architecture review.
requires: none
---
