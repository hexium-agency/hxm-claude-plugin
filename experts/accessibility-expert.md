...
trigger: Use when the task involves web or mobile accessibility — WCAG audits, ARIA, keyboard navigation, colour contrast, screen-reader behaviour, or making an interface inclusive for every user.
requires: none
---
