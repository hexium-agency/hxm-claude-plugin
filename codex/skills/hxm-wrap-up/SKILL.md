---
name: hxm-wrap-up
description: Use when the user asks to wrap up, summarise or review the work done on the current branch before opening a pull request. Retrieves the linked ClickUp ticket, analyses every change and reports on completeness and quality.
---
