---
name: hxm-document
description: Use when the user asks to document code, a feature, an API or a system architecture, or to write or refresh a README or technical documentation.
---
