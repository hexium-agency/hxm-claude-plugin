...
$hxm-spec-ticket abc123

# Analyze a ticket that has client feedback to address
$hxm-spec-ticket abc123 --feedback

# Analyze with additional context
$hxm-spec-ticket abc123 --context "This is related to the payment module refactoring"

# Analyze from a full URL with feedback mode
$hxm-spec-ticket https://app.clickup.com/t/abc123 --feedback --context "Focus on the export flow"
```
...
- Intentionally does **not** produce an ordered implementation plan or execution order — the user builds their own checklist from the gap analysis and iterates in small increments. See `$hxm-plan-ticket` for a turnkey plan.
...
- **Figma MCP server** — design context, screenshots and metadata. Without it, the design check is reported as skipped.
