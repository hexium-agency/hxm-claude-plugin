---
name: hxm-code-review-expert
description: Use when reviewing code for security, performance, maintainability, design patterns or technical debt — on a git diff, before a commit, or as a quality gate.
---
