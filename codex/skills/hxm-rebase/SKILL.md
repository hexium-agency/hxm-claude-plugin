---
name: hxm-rebase
description: Use when the user asks to rebase the current branch, bring it up to date with its base, or resolve rebase conflicts. Auto-resolves trivial conflicts, stops on business-logic ones and force-pushes only with --force-with-lease.
---
