---
name: hxm-explain
description: Use when the user asks to explain, break down or walk through existing code, a pattern, a module or a system architecture, without modifying anything.
---
