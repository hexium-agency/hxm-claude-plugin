...
argument-hint: [<pasted-test-output>] [--run]
allowed-tools: [Read, Grep, Glob, Edit, Bash(sail artisan test:*), Bash(sail npm run build:*), Bash(git diff:*), Bash(git log:*), Bash(git branch:*), Bash(git merge-base:*), Bash(git reflog:*)]
model: sonnet
---
