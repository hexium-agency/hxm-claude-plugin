...
argument-hint: <comment-url-or-file>
allowed-tools: [Read, Grep, Glob, Edit, Write, Bash(gh api:*), Bash(git diff:*), Bash(git log:*), Bash(git branch:*), Bash(git merge-base:*), mcp__clickup]
model: sonnet
---
