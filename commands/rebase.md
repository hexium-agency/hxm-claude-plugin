...
argument-hint: [<base-branch>] [--ci]
allowed-tools: [Read, Edit, Bash(git fetch:*), Bash(git rebase:*), Bash(git status:*), Bash(git diff:*), Bash(git log:*), Bash(git branch:*), Bash(git merge-base:*), Bash(git reflog:*), Bash(git add:*), Bash(git push --force-with-lease:*), Bash(sail:*)]
model: sonnet
---
